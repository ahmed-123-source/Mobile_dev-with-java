    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainProductActivity.this, CategoryActivity.class);
        ...
        customAdapter = new CustomAdapter(MainProductActivity.this,this, book_id, book_title, book_author,
                book_pages);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_logout:
                ...
                startActivity(new Intent(MainProductActivity.this, LoginActivity.class));
                return true;
