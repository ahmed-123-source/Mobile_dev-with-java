...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_AUTHOR = "product_cat";
    private static final String COLUMN_PAGES = "product_price";
...
//Cart
    ...
    void addProduct(String title, String cat, int price){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();

        cv.put(COLUMN_TITLE, title);
        cv.put(COLUMN_AUTHOR, cat);
        cv.put(COLUMN_PAGES, price);
    ...
    //Cart
    void addToCart(String title, String author, int pages){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
...
//Cart
    ...
    void updateData(String row_id, String title, String cat, String price){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_TITLE, title);
        cv.put(COLUMN_AUTHOR, cat);
